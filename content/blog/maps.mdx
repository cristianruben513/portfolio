...
image: "https://res.cloudinary.com/cristian-cloud/image/upload/v1720372617/blog/maps/image_cpe783.webp"
...
<div className="grid grid-cols-2 gap-3">
  <div className="overflow-clip rounded-xl border border-secondary bg-secondary">
    <Image
      src="https://res.cloudinary.com/cristian-cloud/image/upload/blog/maps/nyc-light_mnh7lx.webp"
      alt="Light map"
      width={320}
      height={320}
      reset
  ...
  <div className="overflow-clip rounded-xl border border-secondary bg-secondary">
    <Image
      src="https://res.cloudinary.com/cristian-cloud/image/upload/blog/maps/nyc-dark_uadnf8.webp"
      alt="dark map"
      width={320}
      height={320}
      reset
